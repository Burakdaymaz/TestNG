...
public class Listeners implements ITestListener, IRetryAnalyzer, IAnnotationTransformer {
    ...
    public void onStart(ITestContext context) {  //@BeforeClass gibi
        System.out.println("onStart Method -> Tüm testlerden önce tek bir sefer cagrilir" + context.getName());
    }

    @Override
    public void onFinish(ITestContext context) {
        System.out.println("onFinish Methode -> Tüm testlerden sonra tek bir sefer cagrilir" + context.getName());
    }
